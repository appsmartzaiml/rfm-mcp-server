...
const server = new Server(
    { name: "radiofm-mcp-server", version: "1.3.0" },
    { capabilities: { tools: {} } }
);
    ...
    tools: [
        {
            ...
            description:
                "Search for radio stations and podcasts on RadioFM by name, language, country, or genre.",
            inputSchema: {
                type: "object",
                properties: {
                    query: {
                        type: "string",
                        description:
                            "Search term (e.g., 'BBC', 'India', 'Hindi', 'Jazz', 'News')",
                    },
                },
                required: ["query"],
            },
...
const callTool = async (query: string) => {
